CREATE DATABASE daftar_provinsi;

USE daftar_provinsi;

CREATE TABLE
provinsi(id_prov INT,
pulau VARCHAR(50),
provinsi VARCHAR(50),
singkatan_iso VARCHAR(10),
ibu_kota VARCHAR(50),
diresmikan_sebagai_provinsi DATE,
populasi_proyeksi_bps_2014 INT,
luas_total_km DECIMAL(8,2),
populasi_per_luas INT,
apbd_2014_miliar_rupiah DECIMAL(7,2),
pdrb_2014_triliun_rupiah DECIMAL(6,2),
pdrb_per_kapita_2014_juta_rupiah DECIMAL(5,2),
ipm_2014 DECIMAL(4,2));
...
('5','Sumatra','Kepulauan Riau','KR','Tanjung Pinang','2002-10-25','1917415','8201.72','237','3944.69','182.92','95.4','73.4'),
('6','Sumatra','Jambi','JA','Jambi','1957-08-09','3344400','50058.16','63','3548.66','153.86','46','68.24'),
...
('9','Sumatra','Kepulauan Bangka Belitung','BB','Pangkal Pinang','2000-11-21','1343900','16424.06','82','2276.18','56.39','241.96','68.27'),
...
('12','Jawa','Jawa Barat','JB','Bandung','1950-07-04','46029668','35377.76','1306','23067.20','1385.96','30.11','68.8'),
...
('15','Jawa','Yogyakarta','YO','Yogyakarta','1950-03-04','3553100','3133.15','1134','3662.33','93.45','26.3','76.81'),
('16','Jawa','Jawa Timur','JI','Surabaya','1950-07-04','38610202','47799.75','806','18786.51','1540.70','39.9','68.14'),
...
('19','Kepulauan Nusa Tenggara','Nusa Tenggara Timur','NT','Kupang','1958-08-14','5036897','48718.10','106','2916.88','68.6','13.62','62.26'),
...
('25','Sulawesi','Gorontalo','GO','Gorontalo','2000-12-22','1115633','11257.07','93','1406.32','25.2','22.59','65.17'),
('26','Sulawesi','Sulawesi Barat','SR','Mamuju','2004-10-05','1258090','16787.18','75','1388.27','29.39','23.36','62.24'),
('27','Sulawesi','Sulawesi Selatan','SN','Makassar','1960-12-13','8432163','467171.48','183','6186.39','300.12','35.59','68.49'),
